             ...
             <Container>
                 ...
                 <Navbar.Collapse id="responsive-navbar-nav">
                     ...
                     <Nav>
                         ...
                         {props.isLogin?(<a type="button" className="btn ms-3 btn-success d-flex" href="/api/user/logout">Logout</a>):(<Link type="button" className="btn ms-3 btn-success d-flex" href="/user/login">Login</Link>)}
